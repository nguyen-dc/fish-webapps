...
{
    [Route("api/stock_receive_pay_slips")]
    public class StockReceivePayslipController : BaseController
    {
        ...
        //{
        //    APIResponse<PagedList<StockReceivePaySlipModel>> response = await PostAsJsonAsync<PagedList<StockReceivePaySlipModel>>(URI_API.SUPPLIER_SEARCH, _model);
        //    return Ok(response);
        //}
        ...
        //    APIResponse<StockReceivePayslipModel> response = await GetAsync<StockReceivePayslipModel>(link);
        //    return Ok(response);
        //}
        //[HttpPost("add")]
        //public async Task<ActionResult> Add([FromBody]StockReceivePayslipModel _model)
        //{
        ...
        //public async Task<ActionResult> Modify(int _objectId, [FromBody]StockReceivePayslipModel _model)
        //{
