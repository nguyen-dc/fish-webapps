...
import { ReleaseLivestockModel, FeedingLivestockModel, CollectDeadstockRequest, FCRCheckModel } from "../models/import-stock";
...
export const LivestockProceedAPICaller = {
    ...
    FCRCheck: async (model: FCRCheckModel) => await APICallerBase.Post("api/livestock-proceeds/fcr-check", model),
}